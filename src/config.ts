...
export const siteConfig = {
  enabledChains: ["near"],
  projectName: "Mintbase",
  title: "Mintbase Roadmap",
  metaDescription: "Mintbase Roadmap",
  url: "https://mintbase.betterhq.org/",
  ...
  externalLinks: {
    docs: "https://github.com/better-feedback/better-mintbase#readme",
    discord: "wwwwRFa6aj",
    twitter: "betterdao",
  },
};
